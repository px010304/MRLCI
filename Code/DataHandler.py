...
#        relations = np.array([])  # 初始化为一个空数组，或者基于你的数据结构进行适当的初始化
#
#
#        positive_threshold = 0.8
#        negative_threshold = 0.2
#
#        positive_indices = np.where(relations > positive_threshold)[0]
#        negative_indices = np.where(relations < negative_threshold)[0]
